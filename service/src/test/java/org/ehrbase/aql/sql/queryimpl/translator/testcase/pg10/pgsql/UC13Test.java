...
public class UC13Test extends UC13 {
    ...
    public UC13Test() {
        ...
        this.expectedSqlExpression =
                "select count(\"count_magnitude\") as \"count_magnitude\" from (select (ARRAY.COLUMN#>>'{/description[at0001],/items[at0004],0,/value,magnitude}')::bigint as \"count_magnitude\" from \"ehr\".\"entry\" join lateral (\n"
