...
public class FolderAccessTest {
    ...
    public void shouldRetriveFolderAccessByUid() throws Exception {
        ...
        assertEquals(
                ...
                ((FolderAccess) fa2).getFolderRecord().getName());
        assertEquals(
                "[\"2019-08-09 09:56:52.464799+02\",)",
                ((FolderAccess) fa2).getFolderRecord().getSysPeriod().toString());
        assertEquals(
                "{\"details\": \"xxx1\"}",
                ((FolderAccess) fa2).getFolderRecord().getDetails().toString());
        ...
        assertEquals(
                ...
                ((FolderAccess) fa2.getSubfoldersList().get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb")))
                        .getFolderRecord()
                        .getName());
        DateTimeFormatter dateTimeFormatter = DateTimeFormat.forPattern("YYYY-MM-dd HH:mm:ss.SSS");
        DateTime expected = DateTime.parse("2019-06-13 18:10:33.760", dateTimeFormatter);
        DateTime actual = DateTime.parse(
                ((FolderAccess) fa2.getSubfoldersList()
                                .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                                .getSubfoldersList()
                                .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb")))
                        .getFolderRecord()
                        .getSysTransaction()
                        .toString(),
                dateTimeFormatter);
        ...
        assertEquals(
                1,
                fa2.getSubfoldersList()
                        .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                        .getSubfoldersList()
                        .size());
        assertNotNull(fa2.getSubfoldersList()
                .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                .getSubfoldersList()
                .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb")));
        assertEquals(
        ...
        assertTrue(((FolderAccess) fa2.getSubfoldersList()
                        .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                        .getSubfoldersList()
                        .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb")))
                .getFolderRecord()
        ...
        assertNotNull(fa2.getSubfoldersList()
                ...
                .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
                .getSubfoldersList()
                .get(UUID.fromString("77750555-ec91-4025-838d-09ddb4e999cb")));
        ...
        assertNotNull(fa2.getSubfoldersList()
                ...
                .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
                .getSubfoldersList()
                .get(UUID.fromString("8701233c-c8fd-47ba-91b5-ef9ff23c259b")));
    }
    ...
    public void shouldRetrieveFolderAccessWithItems() throws Exception {
        ...
        assertEquals(
                "48282ddd-4c7d-444a-8159-458a03c9827f",
                fa2.getItems().get(0).getId().toString());
        ...
        assertEquals(
                ...
                fa2.getSubfoldersList()
                        ...
                        .getType());
        assertEquals(
                "076f09ee-8da3-ae1b-0072-3ee18965fbb9",
                fa2.getSubfoldersList()
                        .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                        .getSubfoldersList()
                        .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
        ...
        assertEquals(
                ...
                fa2.getSubfoldersList()
                        ...
                        .getType());
        assertEquals(
                "5bf07118-e22e-e233-35c9-78820d76627c",
                fa2.getSubfoldersList()
                        .get(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                        .getSubfoldersList()
                        .get(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
    ...
    public void shouldInsertFolderWithNoSubfolders() throws Exception {
        // the creation and commit returning valid ids implies that the FolderMockDataProvider.java has provided the
        // corresponding result for each SQL generated when inserting
        ...
        assertEquals(
                ...
                fa2.getFolderRecord().getId().toString());
        ...
        String expected = ("'{\n" + "  \"_type\" : \"\",\n"
                ...
                .replaceAll(
                        "\\n|\\r\\n",
                        System.getProperty(
                                "line.separator")); // avoids problems amond different platforms due to different
        // representations of line change.
        StringWriter expectedStringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(expectedStringWriter);
        printWriter.print(
                expected); // avoids problems amond different platforms due to different representations of line change.
        printWriter.close();

        assertEquals(
                expectedStringWriter.toString(),
                fa2.getFolderRecord().getDetails().toString());
    ...
    public void shouldInsertFolderWithSubfolders() throws Exception {
        ...
        assertEquals(
                "f0a2af65-fe89-45a4-9456-07c5e17b1634",
                ((FolderAccess) fa2.getSubfoldersList().get(UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634")))
                        .getFolderRecord()
                        .getId()
                        .toString());
        assertEquals(
        ...
        printWriter = new PrintWriter(
                expectedStringWriter); // avoids problems amond different platforms due to different representations of
        // line change.
        ...
        assertEquals(
                "f4a2af65-fe89-45a4-9456-07c5e17b1634",
                ((FolderAccess) ((FolderAccess) fa2.getSubfoldersList()
                                        .get(UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634")))
                                .getSubfoldersList()
                                .get(UUID.fromString("f4a2af65-fe89-45a4-9456-07c5e17b1634")))
                        .getFolderRecord()
                        .getId()
                        .toString());
        assertEquals(
        ...
        printWriter.print(
                expected3); // avoids problems amond different platforms due to different representations of line
        // change.
        assertEquals(
                expectedStringWriter.toString(),
                ((FolderAccess) ((FolderAccess) fa2.getSubfoldersList()
    ...
    public void shouldUpdateExistingFolder() throws Exception {
        ...
        fa2.setFolderSysPeriod(
                new AbstractMap.SimpleEntry<>(OffsetDateTime.parse("2019-07-26 11:28:11.631959+02"), null));
        ...
        // the mock data provider checks the UPDATE SQL code generated and returns 1 simulating the update of one row in
        // the FOLDER table.
        // this way the correct sql generation is checked indirectly.
        boolean updated = false;
        updated = fa2.update(LocalDateTime.now(), UUID.randomUUID());
        // assertEquals(true, updated);// could not manage to mock the result "Affected row(s)          : 1" from
        // updates" for the UPDATEE statement. The mock data provider returns 0 irrespectively of weather the record is
        // modified in the DB or not. As a consequence this always is false in the mocked version.
    }
    ...
    public void shouldDeleteExistingFolder() {
        ...
        // mocked. Now checked relyingon the Moch Data Provider that intercepts the SQL code generated.
    }
