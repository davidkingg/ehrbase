    ...
    public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
        ...
        if (sql2.toUpperCase().startsWith("DROP")) {
            ...
            if (ctx.bindings()[1].equals(UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"))) {
                ...
                .contains(
                        "select \"folder_union_fol_hist\".\"id\", \"folder_union_fol_hist\".\"in_contribution\", \"folder_union_fol_hist\".\"name\", \"folder_union_fol_hist\".\"archetype_node_id\"")) {
            ...
            if (ctx.bindings()[1].equals(UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"))) {
                ...
                result2.add(create.newRecord(
                        ...
                        .values(
                                UUID.fromString("eda6951b-5506-4726-89dc-7032872997ce"),
                                UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                "folder_archetype_nameLeave1",
                                "folder_archetypeLeave.v1",
                                true,
                                null,
                                Timestamp.valueOf("2019-12-05 19:00:00.688"),
                                new AbstractMap.SimpleEntry<>(
                ...
                if (sql2.toLowerCase()
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    ...
                                    UUID.fromString("7f069129-7312-447b-bd71-567305a9a871"),
                                    UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                    "folder_archetype_root init",
                                    "folder_archetypeRoot.v1",
                                    true,
                                    null,
                                    Timestamp.valueOf("2019-12-05 19:00:00.688"),
                                    new AbstractMap.SimpleEntry<>(
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    ...
                                    UUID.fromString("129dc79c-e0bc-4946-bfa6-28ce609bbd2c"),
                                    UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                    "folder_archetype_middle1",
                                    "folder_archetypemiddle.v1",
                                    true,
                                    null,
                                    Timestamp.valueOf("2019-12-05 19:00:00.688"),
                                    new AbstractMap.SimpleEntry<>(
