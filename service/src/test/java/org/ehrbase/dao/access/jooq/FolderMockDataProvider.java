    ...
    public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
        ...
        if (sql2.toUpperCase().startsWith("DROP")) {
            ...
            throw new SQLException("Statement not supported: " + sql2);
                ...
                .contains(
                        "DELETE FROM \"EHR\".\"FOLDER_ITEMS\" WHERE (\"EHR\".\"FOLDER_ITEMS\".\"FOLDER_ID\" = ? AND \"EHR\".\"FOLDER_ITEMS\".\"IN_CONTRIBUTION\" = ?)")) {
            mock[0] = new MockResult(1, create.newResult(FOLDER_ITEMS));
            return mock;
        } else if (sql2.toUpperCase()
                .contains(
                        "INSERT INTO \"EHR\".\"FOLDER_ITEMS\" (\"FOLDER_ID\", \"OBJECT_REF_ID\", \"IN_CONTRIBUTION\", \"SYS_TRANSACTION\", \"SYS_PERIOD\")")) {
            ...
            return mock;
                ...
                .contains(
                        "INSERT INTO \"EHR\".\"OBJECT_REF\" (\"ID_NAMESPACE\", \"TYPE\", \"ID\", \"IN_CONTRIBUTION\", \"SYS_TRANSACTION\", \"SYS_PERIOD")) {
            mock[0] = new MockResult(1, create.newResult(OBJECT_REF));
            return mock;

        } else if (sql2.toLowerCase()
                .contains(
                        "select \"ehr\".\"folder\".\"id\", \"ehr\".\"folder\".\"in_contribution\", \"ehr\".\"folder\".\"name\", \"ehr\".\"folder\".\"archetype_node_id\", \"ehr\".\"folder\".\"active\", \"ehr\".\"folder\".\"details\", \"ehr\".\"folder\".\"sys_transaction\", \"ehr\".\"folder\".\"sys_period\" from \"ehr\".\"folder\" where \"ehr\".\"folder\".\"id\" = ?")) {
            if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("77750555-ec91-4025-838d-09ddb4e999cb")) == 0) {
                ...
                return mock2;
            } else if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("8701233c-c8fd-47ba-91b5-ef9ff23c259b"))
                    == 0) {
            ...
            throw new SQLException(
                    "SQL statement not expected. Consider enhancing or revising the FolderMockDataProvider in order to ensure the controlled behaviour of your code: "
                            + sql2);

        } else if (sql2.toUpperCase()
                .startsWith(
                        "SELECT \"EHR\".\"CONTRIBUTION\".\"EHR_ID\" FROM \"EHR\".\"CONTRIBUTION\" WHERE \"EHR\".\"CONTRIBUTION\".\"ID\" =")) {
            ...
            if (sql2.toUpperCase()
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                    ...
                    MockResult[] mock2 = new MockResult[1];
                    Result<Record4<UUID, UUID, UUID, Timestamp>> result2 = create.newResult(
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                        == 0) { // TABLE FOR THE RETRIEVE FOLDER ACCESS FOR EXISTING FOLDER
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    ...
                                    new AbstractMap.SimpleEntry<>(
                                            OffsetDateTime.parse("2019-08-09T09:56:52.464799+02"), null)));
                    result2.add(create.newRecord(
                                    FOLDER_HIERARCHY.PARENT_FOLDER,
                                    FOLDER_HIERARCHY.CHILD_FOLDER,
                                    FOLDER_HIERARCHY.IN_CONTRIBUTION,
                ...
                Result<
                        ...
                        result2 = create.newResult(
                                ...
                                OBJECT_REF.SYS_TRANSACTION,
                                OBJECT_REF.SYS_PERIOD,
                                FOLDER_ITEMS.OBJECT_REF_ID,
                                FOLDER_ITEMS.IN_CONTRIBUTION);
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    "namespace",
                                    "FOLDER",
                                    UUID.fromString("48282ddd-4c7d-444a-8159-458a03c9827f"),
                                    UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                    new Timestamp(expected.getMillis()),
                                    new AbstractMap.SimpleEntry<>(
                                            OffsetDateTime.parse("2019-08-09T09:56:52.464799+02"), null),
                ...
                } else if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
                        == 0) {
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    "namespace2",
                                    "COMPOSITION",
                                    UUID.fromString("076f09ee-8da3-ae1b-0072-3ee18965fbb9"),
                                    UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                    new Timestamp(expected.getMillis()),
                                    new AbstractMap.SimpleEntry<>(
                                            OffsetDateTime.parse("2019-08-09T09:56:52.464799+02"), null),
                    ...
                    result2.add(create.newRecord(
                            ...
                            .values(
                                    "namespace3",
                                    "EHR",
                                    UUID.fromString("5bf07118-e22e-e233-35c9-78820d76627c"),
                                    UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"),
                                    new Timestamp(expected.getMillis()),
                                    new AbstractMap.SimpleEntry<>(
                                            OffsetDateTime.parse("2019-08-09T09:56:52.464799+02"), null),
            ...
            throw new SQLException(
                ...
                .contains("SELECT 1 AS \"ONE\"")) { // query needed for mocking initialization of the system
            ...
            return mock;
                ...
                .contains("SELECT \"EHR\".\"PARTY_IDENTIFIED\"")) { // query needed for mocking initialization of the
            // system
            System.out.println("SQL2 is: " + sql2.toUpperCase());
            System.out.println("PARTY_IDENTIFIED hist selected");
            Result<Record6<UUID, String, String, String, String, String>> result2 = create.newResult(
                    PARTY_IDENTIFIED.ID,
            ...
            return mock;
                ...
                .contains(
                        "SELECT \"EHR\".\"SYSTEM\".\"ID\" FROM \"EHR\".\"SYSTEM\" WHERE \"EHR\".\"SYSTEM\".\"SETTINGS\" =")) { // query needed for mocking initialization of the system
            ...
            return mock;
                ...
                .contains(
                        "SELECT \"EHR\".\"CONCEPT\".\"ID\", \"EHR\".\"CONCEPT\".\"CONCEPTID\", \"EHR\".\"CONCEPT\".\"LANGUAGE\", \"EHR\".\"CONCEPT\".\"DESCRIPTION\"")) { // query needed for mocking initialization of the system
            Result<Record4<UUID, Integer, String, String>> result2 =
                    create.newResult(CONCEPT.ID, CONCEPT.CONCEPTID, CONCEPT.LANGUAGE, CONCEPT.DESCRIPTION);
            result2.add(create.newRecord(CONCEPT.ID, CONCEPT.CONCEPTID, CONCEPT.LANGUAGE, CONCEPT.DESCRIPTION)
                    .values(
                            UUID.fromString("dcd3b8c5-36e3-4ac7-83aa-7e9068f443d8"),
                            new Integer(249),
                            "en",
                            "creation"));
            mock[0] = new MockResult(1, result2);
            ...
            if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("f6a2af65-fe89-45a4-9456-07c5e17b1634")) == 0) {
                ...
                result2.add(create.newRecord(CONTRIBUTION.ID)
            ...
            throw new SQLException(
                    "Statement not currently supported. Consider enhancing or revising the FolderMockDataProvider: "
                            + sql2);
            ...
            if (sql2.toUpperCase()
                    .startsWith(
                            ("INSERT INTO \"EHR\".\"FOLDER\" (\"ID\", \"IN_CONTRIBUTION\", \"NAME\", \"ARCHETYPE_NODE_ID\", \"ACTIVE\", \"DETAILS\", \"SYS_TRANSACTION\") VALUES (?, ?, ?, ?, ?, '{\n"
                                    + "  \"_TYPE\" : \"\",\n"
                                    + "  \"ITEMS\" : [ {\n"
                                    + "    \"NAME\" : {\n"
                                    + "      \"_TYPE\" : \"DV_TEXT\",\n"
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634"))
                        == 0) {
                    Result<Record1<UUID>> result2 = create.newResult(FOLDER.ID);
                    result2.add(create.newRecord(FOLDER.ID)
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("f8a2af65-fe89-45a4-9456-07c5e17b1634"))
                        == 0) {
                    Result<Record1<UUID>> result2 = create.newResult(FOLDER.ID);
                    result2.add(create.newRecord(FOLDER.ID)
                ...
                if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("f4a2af65-fe89-45a4-9456-07c5e17b1634"))
                        == 0) {
                    Result<Record1<UUID>> result2 = create.newResult(FOLDER.ID);
                    result2.add(create.newRecord(FOLDER.ID)
            ...
            throw new SQLException(
                ...
                .startsWith(
                        "INSERT INTO \"EHR\".\"FOLDER_HIERARCHY\" (\"PARENT_FOLDER\", \"CHILD_FOLDER\", \"IN_CONTRIBUTION\", \"SYS_TRANSACTION\") VALUES")) {

            String uidParentFolder = ((UUID) ctx.bindings()[0]).toString();
            String uidChildFolder = ((UUID) ctx.bindings()[1]).toString();

            if ((uidParentFolder.equals("f0a2af65-fe89-45a4-9456-07c5e17b1634"))
                    && (uidChildFolder.equals("f4a2af65-fe89-45a4-9456-07c5e17b1634"))) {
                Result<Record2<UUID, UUID>> result2 =
                        create.newResult(FOLDER_HIERARCHY.PARENT_FOLDER, FOLDER_HIERARCHY.CHILD_FOLDER);
                result2.add(create.newRecord(FOLDER_HIERARCHY.PARENT_FOLDER, FOLDER_HIERARCHY.CHILD_FOLDER)
                        .values(
                                UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634"),
                                UUID.fromString("f4a2af65-fe89-45a4-9456-07c5e17b1634")));
                mock[0] = new MockResult(1, result2);
                return mock;

            } else if ((uidParentFolder.equals("f8a2af65-fe89-45a4-9456-07c5e17b1634"))
                    && (uidChildFolder.equals("f0a2af65-fe89-45a4-9456-07c5e17b1634"))) {
                Result<Record2<UUID, UUID>> result2 =
                        create.newResult(FOLDER_HIERARCHY.PARENT_FOLDER, FOLDER_HIERARCHY.CHILD_FOLDER);
                result2.add(create.newRecord(FOLDER_HIERARCHY.PARENT_FOLDER, FOLDER_HIERARCHY.CHILD_FOLDER)
                        .values(
                                UUID.fromString("f8a2af65-fe89-45a4-9456-07c5e17b1634"),
                                UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634")));
                mock[0] = new MockResult(1, result2);
                return mock;
            }
            ...
            return mock;
                ...
                .startsWith(
                        "UPDATE \"EHR\".\"CONTRIBUTION\" SET \"EHR_ID\" = ?, \"CONTRIBUTION_TYPE\" = ?::\"EHR\".\"CONTRIBUTION_DATA_TYPE\", \"STATE\" =")) {
            Field<Integer> c = DSL.count();
            Result<Record1<Integer>> result2 = create.newResult(c);
            result2.add(create.newRecord(c).values(1));
            mock[0] = new MockResult(1, result2);
            return mock;
                ...
                .startsWith(
                        "UPDATE \"EHR\".\"FOLDER\" SET \"ID\" = ?, \"IN_CONTRIBUTION\" = ?, \"NAME\" = ?, \"ARCHETYPE_NODE_ID\" = ?, \"ACTIVE\" = ?, \"DETAILS\" = ")) {

            if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb")) == 0)
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((String) ctx.bindings()[2]).compareTo("modifiedName") == 0)
                    && (((String) ctx.bindings()[3]).compareTo("modifiedArchetypeNodeId") == 0)
                    && (((Boolean) ctx.bindings()[4]).compareTo(false) == 0)) {
                mock[0] = new MockResult(1, create.newResult(FOLDER));
                return mock;

            } else if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((String) ctx.bindings()[2]).compareTo("new name of folder 2") == 0)
                    && (((String) ctx.bindings()[3]).compareTo("folder_archetype.v1") == 0)
                    && (((Boolean) ctx.bindings()[4]).compareTo(true) == 0)) {
                ...
                return mock;
                    ...
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((String) ctx.bindings()[2]).compareTo("folder_archetype_name_3") == 0)
                    && (((String) ctx.bindings()[3]).compareTo("new archetype node id") == 0)
                    && (((Boolean) ctx.bindings()[4]).compareTo(true) == 0)) {
                ...
                return mock;
                    ...
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((String) ctx.bindings()[2]).compareTo("folder_archetype_name_5") == 0)
                    && (((String) ctx.bindings()[3]).compareTo("folder_archetype.v1") == 0)
                    && (((Boolean) ctx.bindings()[4]).compareTo(false) == 0)) {

                mock[0] = new MockResult(1, create.newResult(FOLDER));
                return mock;
            } else if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("77750555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((String) ctx.bindings()[2]).compareTo("folder_archetype_name_4") == 0)
                    && (((String) ctx.bindings()[3]).compareTo("folder_archetype.v1") == 0)
                    && (((Boolean) ctx.bindings()[4]).compareTo(true) == 0)) {

                mock[0] = new MockResult(1, create.newResult(FOLDER));
                return mock;
            } else if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
                            == 0)
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString("3e2fcd27-d846-4a0d-888a-47b2da9e5cbb"))
                            == 0)) {
                ...
                .startsWith(
                        "DELETE FROM \"EHR\".\"FOLDER\" WHERE (\"EHR\".\"FOLDER\".\"ID\" IN (?, ?, ?, ?) OR \"EHR\".\"FOLDER\".\"ID\" = ?)")) {
            ...
            if (((UUID) ctx.bindings()[0]).compareTo(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb")) == 0) {
                ...
                .startsWith(
                        "insert into \"ehr\".\"audit_details\" (\"system_id\", \"committer\", \"time_committed\", \"time_committed_tzid\", \"change_type\") values")) {
            if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString(TEST_SYSTEM_ID)) == 0)
                    && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString(TEST_PARTY_IDENTIFIED_ID)) == 0)) {
                Result<Record1<UUID>> result2 = create.newResult(AUDIT_DETAILS.ID);
                result2.add(create.newRecord(AUDIT_DETAILS.ID)
                        .values(UUID.fromString("3e2fcd27-d846-4a0d-888a-47b2da9e5cbb")));
                mock[0] = new MockResult(1, result2);
                return mock;
            }
